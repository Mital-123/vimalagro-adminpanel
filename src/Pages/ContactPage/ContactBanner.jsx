...
function ContactBanner() {
    ...
    const [currentImages, setCurrentImages] = useState({ desktopcontactbanner: "", mobilecontactbanner: "" });

    const desktopInputRef = useRef(null);
    const mobileInputRef = useRef(null);

    const API_URL = "https://backendvimalagro.onrender.com/contactbanner";
    ...
    const handleSubmit = async (e) => {
        ...
        if (desktopBanner) formData.append("desktopcontactbanner", desktopBanner);
        if (mobileBanner) formData.append("mobilecontactbanner", mobileBanner);
    ...
    const handleEdit = (item) => {
        ...
        setMobileBanner(null);
        setCurrentImages({
            desktopcontactbanner: item.desktopcontactbanner,
            mobilecontactbanner: item.mobilecontactbanner,
        });
    ...
    return (
        <div className="container mt-3 mt-lg-0 mt-md-0">
            <h3 className="fw-bold text-center mb-3 mb-md-4 main-tittle">Contact Us Banner</h3>
                ...
                <div className="rounded-3 shadow overflow-hidden">
                    ...
                    >
                        <h6 className="fw-bold m-0 text-dark">
                            <FaPlus className="me-2" /> {editId ? "Edit Contact Us Banner" : "Add Contact Us Banner"}
                        </h6>
                    </div>
                    <div className="px-4 pb-4 pt-2 bg-white">
                        <div className="d-lg-flex d-md-flex gap-3">
                            ...
                            <div className="w-100 w-lg-50 w-md-50 mt-2">
                                ...
                                <input
                                    type="file"
                                    name="mobilecontactbanner"
                                    accept="image/*"
                                    className="mt-1 w-100 form-control border border-secondary"
                                    onChange={(e) => {
                                        setMobileBanner(e.target.files[0]);
                                        setCurrentImages(prev => ({ ...prev, mobilecontactbanner: "" })); // Clear old path
                                    }}
                                    ref={mobileInputRef}
                                    disabled={isDisabled}
                                />
                                {editId && currentImages.mobilecontactbanner && (
                                    <div className="mt-1 text-secondary" style={{ fontSize: "12px", whiteSpace: "normal", wordBreak: "break-all" }}>
                                        {currentImages.mobilecontactbanner}
                                    </div>
                                )}
                            </div>
                        </div>
